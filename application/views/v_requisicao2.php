        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="requisicoes/create" method="post" id="form" class="form-horizontal">
                    ...
                    <input name="usuario_requisicao" value="<?php echo $this->session->userdata('ID'); ?>" class="form-control" type="hidden">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="datepicker" name="data_requisicao" placeholder="Data Emissão" class="form-control" value="<?php echo date('Y-m-d') ;?>" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
