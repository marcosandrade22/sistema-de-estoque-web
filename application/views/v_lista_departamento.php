...
function delete_produtos(id)
{
    if(confirm('Tem certeza que deseja deletar este registro?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('estoque/departamento_delete/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nome Departamento</label>
                            <div class="col-md-9">
                                <input name="nome_departamento" placeholder="Nome Departamento" class="form-control" type="text">
