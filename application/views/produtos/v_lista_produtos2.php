...
function edit_produtos(id)
{
    ...
    $.ajax({
        ...
        {
             var estoque;
             if(data.quantidade_qt == undefined){
             estoque = 0;
            }
            else{
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="estoque/produto_update" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group ">
                                    <label class="control-label col-md-3">Imagem do Produto</label>
                                     <div class="col-md-9">
                                         <!--
                                        <input id="field-nascimento_usuario" onclick="openKCFinder(this)" value="<?php echo set_value('imagem_produto') ? : (isset($imagem_produto) ? $imagem_produto : '') ?>" name="imagem_produto" type="text"  class="form-control">
                                         -->
                                          <input class="form-control" type="file" name="imagem_produto" value="<?php echo set_value('imagem_produto') ? : (isset($imagem_produto) ? $imagem_produto : '') ?>" size="20" />
                                         <span class="help-block"></span>
                            </div>
                            </div>
                        <div class="form-group">
