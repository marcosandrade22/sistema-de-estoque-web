                            ...
                            <div class="dataTable_wrapper">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting table_header" tabindex="0"  rowspan="1" colspan="1"style="//width: 20px;">Qt. ini</th>
                                              ...
                                              -->
                                           <th class="sorting table_header" tabindex="0"  rowspan="1" colspan="1"  style="//width: 201px;">Saldo Final</th>
                                           <th class="sorting table_header" tabindex="0"  rowspan="1" colspan="1"  style="//width: 201px;">Valor Final</th>
                               ...
                               <tr class="gradeA even" role="row">
                                     <td style="text-align: left"><?php 
                                            echo $relatorio->id_produto;
                                            //echo $relatorio->departamento_estoque.'oi';
                                            ?>
                                   </td>       
                                   <td style="text-align: left"><?php 
                                            echo $relatorio->nome_produto;
                                            //echo date('d-m-Y', strtotime($relatorio->data_baixa)); ?>
                                   </td>
                                  ...
                                  <!-- <td>
                                   ...
                                   <td>
                                    ...
                                    <td style="text-align: center">
                                         <?php // qantidade atual periodo
                                       //$query9 = $this->db->query("SELECT * FROM estoque_qt WHERE data_rq >= '$data_in' AND data_rq <= '$data_fim' AND id_pro_req_est=$relatorio->produto_estoque AND departamento_rq=$relatorio->departamento_estoque ");   
                                      // $quant_atual = "0"; 
                                       //foreach($query9->result() as $qt_atual):
                                     // $quant_atual= $quant_atual+$qt_atual->qt_pro_req_est; 
                                     // $preco_atual = $qt_atual->valor_rq;
                                     //  endforeach;
