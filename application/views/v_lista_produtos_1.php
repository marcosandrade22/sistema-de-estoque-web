...
<body>
    ...
    <div class="container margin-top">
        ...
        <br />
        <button class="btn btn-success" onclick="add_produtos()"><i class="glyphicon glyphicon-plus"></i> Adicionar Produto</button>
...
$(document).ready(function() {
    ...
    "oPaginate": {
       ...
       "sLast":     "Último"
        ...
        "ajax": {
            "url": "<?php echo site_url('produtos/ajax_list')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('produtos/ajax_add')?>";
    } else {
        url = "<?php echo site_url('produtos/ajax_update')?>";
    }
...
function delete_produtos(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('produtos/ajax_delete/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
