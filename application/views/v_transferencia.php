...
<body>
    ...
    <div class="container margin-top">
        ...
        <?php foreach($produto as $produto):?>
            <span class="text-primary"><?php echo $produto->visao_nome; ?></span>
            
        </h3>
       
        Código Interno: <b><?php echo $produto->visao_cod; ?></b><br>
        Código de barras : <b><?php echo $produto->visao_cod_barra ; ?></b><br>
        Estoque Disponível : <b><?php echo $produto->visao_quantidade ; ?></b><br>
        <?php endforeach; ?>
        <br>
        <div class="row">
        <div class="col-xs-6">
           <form method="post" action="estoque/baixa/<?php echo $produto->id_visao; ?>" >
               <div class="row">
                   <div class="col-xs-12">
               ...
               <div class="row">
                   <div class="col-xs-2">
                       ...
                       <input type="quantidade" class="form-control" />
                       </div>
                   </div>
                   ...
                   <div class="col-xs-6">
                       ...
                       <input type="departamento" class="form-control" />
                       </div>
                   </div>
               </div>
               
        
               <input type="submit" class="btn btn-success" value="Emitir Solcitação" />   
            </form> 
