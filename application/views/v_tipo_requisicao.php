...
<body>
    ...
    <div class="container margin-top" >
        ...
        <br />
        <button class="btn btn-success" onclick="add_tipo()"><i class="glyphicon glyphicon-plus"></i>Novo Tipo </button>
        ...
        <table id="requisicoes" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $tipo->id_tipo_requisicao; ?></td>
                     <td><?php echo $tipo->nome_tipo_requisicao; ?></td>
                     
                       <td>
                        <a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_tipo('<?php echo $fornecedor->id_tipo_requisicao; ?>')"><i class="glyphicon glyphicon-pencil"></i> Editar</a>
                  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_tipo('<?php echo $fornecedor->id_tipo_requisicao; ?>')"><i class="glyphicon glyphicon-trash"></i> Del</a>
                       </td>
                </tr>
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('requisicoes/tipo_add')?>";
    } else {
        url = "<?php echo site_url('requisicoes/tipo_update')?>";
    }
...
function delete_tipo(id)
{
    if(confirm('Tem certeza que deseja deletar este registro?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('requisicoes/tipo_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="id_tipo_requisicao"/>
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Tipo Requisicao</label>
                            <div class="col-md-9">
                                <input name="nome_tipo_requisicao" placeholder="Tipo Requisicao" class="form-control" type="text">
